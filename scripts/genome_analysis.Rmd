...
Sum of all contamination = 496
This is only 0.00840908% of the raw reads, which is pretty amazing! 
...
(sum(filt_raw_Reads$length)/79183709778)*((79181142809/sum(filt_raw_Reads$length))*100)
```
