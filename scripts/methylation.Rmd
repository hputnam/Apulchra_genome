...
summary_data_meth$methylation_category <- factor(summary_data_meth$methylation_category, levels = c("partially methylated", "methylated"))
...
plot1 <- ggplot(summary_data_meth, aes(x = type, y = percentage, fill = methylation_category)) +
  ...
  scale_fill_manual(values = c("methylated" = "#E64B35", 
                    ...
                    labels = c("Methylated", "Partially methylated")) +
